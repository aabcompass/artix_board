...
write_cfgmem -format bin -interface serialx1 -size 32 -loadbit  "up 0 [get_property top [current_fileset]].bit [get_property top [current_fileset]].bit [get_property top [current_fileset]].bit"  -file triple_bin -force
